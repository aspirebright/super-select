...
export default class SampleSuperSelect extends LightningElement {
    ...
    handleResetRemoval() {
        if (this.removedItemsMultiSelect && this.removedItemsMultiSelect.removedItems) {
            this.template
                .querySelector('[data-id="AccountSourcePicklist"]')
                .resetRemoval(this.removedItemsMultiSelect.removedItems, "Removed Items were added back since these Items can't be removed.", "toast");
    ...
    handleResetSelection() {
        if (this.selectedItemsMultiSelect && this.selectedItemsMultiSelect.selectedItems) {
            this.template
                .querySelector('[data-id="AccountSourcePicklist"]')
                .resetSelection(this.selectedItemsMultiSelect.selectedItems, "Selected Items were removed since these Items can't be selected.", "field-error");
